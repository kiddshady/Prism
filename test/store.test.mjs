...
const parche = await store.saveSettings({ searchEngine: 'duckduckgo' });
ok('guardar un parche no pisa el resto', parche.searchEngine === 'duckduckgo' && parche.adblock === store.DEFAULT_SETTINGS.adblock);
