...
const ROOT = process.env.PRISM_DATA || defaultRoot();
...
const DEFAULT_SETTINGS = {
  schema: SCHEMA,
  /** google · duckduckgo · bing · brave (ver omni.cjs → ENGINES) */
  searchEngine: 'google',
  /** Al abrir: 'restore' vuelve a las pestañas de la última vez; 'newtab' arranca limpio. */
  startup: 'restore',
